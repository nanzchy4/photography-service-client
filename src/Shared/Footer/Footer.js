...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content lg:max-w-screen-lg mx-auto mt-32 ">
            <div>
                ...
                <p>Moment Capture<br />Capturing your precious moments since 2011</p>
            </div>
            <div>
